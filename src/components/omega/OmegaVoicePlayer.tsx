...
export const OmegaVoicePlayer: React.FC<OmegaVoicePlayerProps> = ({
  ...
  if (!speechState.isPlaying && !autoSpeak) {
  ...
  return (
    <div
      dir="rtl"
      className="fixed bottom-24 left-1/2 -translate-x-1/2 z-40 w-[92%] max-w-2xl bg-zinc-950/95 border border-purple-500/30 rounded-2xl shadow-2xl backdrop-blur-xl p-3 text-zinc-100 animate-in fade-in slide-in-from-bottom-3 duration-300"
    >
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <p className="text-[11px] text-zinc-400 truncate max-w-[280px]">
              {speechState.isPlaying ? (speechState.isPaused ? "متوقف مؤقتاً" : "أوميغا يقرأ بصوت متزامن...") : "جاهز للقراءة الصوتية التلقائية"}
            </p>
          </div>
        </div>
        ...
        {/* Right: Controls (Play/Pause, Stop, Speed, Persona Picker) */}
